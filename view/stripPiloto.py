...
class stripPiloto ( guiStrip.guiStrip ):
    ...
    #*  -------------------------------------------------------------------------------------------
    #*/
    def drawStripText ( self, f_srf, f_tStripPos, f_stAtv ):
    ...
    def makeIcon ( self, f_tCor ):
        ...
        #*/
        l_srfIcn = pygame.Surface (( self._tWH [ 0 ], self._iStripHeight - 2 ))
        #assert ( l_srfIcn )
        ...
        #*/
        #l_retStrip = ( 0, 0 ), ( self._tWH [ 0 ], self._iStripHeight - 2 )

...
#*
#*  Descricao: this is the actual flight control for SiPAR.
#*  -----------------------------------------------------------------------------------------------
...
class flightControl ( threading.Thread ):
    ...
    def __init__ ( self, f_cm ):
        ...
        #*  exercício de SiPAR ?
        #*/
        if ( "SiPAR" == self._oExe.getTipoExe ()):
        ...
        #*  exercício de SiCAD ?
        #*/
        elif ( "SiCAD" == self._oExe.getTipoExe ()):

            #** -----------------------------------------------------------------------------------
            #*  obtém o objeto aeródromo
            #*/
            self._oAer = self._oExe.getAerodromo ()
            #assert ( self._oAer )

        #** ---------------------------------------------------------------------------------------
        #*  senão, exercício indefinido
        #*/
        else:
        ...
        #*/
        self._sndAlert = None #pygame.mixer.Sound ( glbDefs.xSND_Alert )
        ##assert ( self._sndAlert )

        self._sndExplode = None #pygame.mixer.Sound ( glbDefs.xSND_Explode )
